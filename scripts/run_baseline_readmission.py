...
from src.datasets.readmission import (
    load_common_config,
    get_readmission_data_splits,
)
...
def main():
    ...
    print("Training baseline readmission model...")
    trainer.train(
    ...
    output_path = results_dir / "baseline_readmission_test_metrics.json"
